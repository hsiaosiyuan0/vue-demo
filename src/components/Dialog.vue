<template>
<section id="dialog" style="height: 1000px;">
  ...
  <button @click="visible1 = true">remove</button>
...
#dialog div.confirm .no {
  color: #fff;
  background-color: #f84f47;
}

#dialog div.confirm .yes {
  color: #fff;
  background-color: #0097ff;
}

#dialog div.confirm .btns {
  overflow: hidden;
  margin-top: 20px;
}

#dialog div.confirm .btns .yes {
  float: left;
}

#dialog div.confirm .btns .no {
  float: right;
}
</style>
